...
input logic [REG_DATAWIDTH-1:0] i_pc_add_immext_or_zero,
...
localparam CHOOSE_PC_ADD_IMMEXT_OR_ZERO = 3'b010;
...
CHOOSE_PC_ADD_IMMEXT_OR_ZERO: o_rd_data = i_pc_add_immext_or_zero;
default: o_rd_data = 'x;
endcase
end
