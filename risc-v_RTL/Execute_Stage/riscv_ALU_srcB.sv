...
output logic [REG_DATAWIDTH-1:0] o_ALU_srcB
);
...
begin
    ...
    CHOOSE_RS2_DATA: o_ALU_srcB = i_rs2_data;
    CHOOSE_MEM: o_ALU_srcB = i_mem_forward_data; 
    CHOOSE_WB: o_ALU_srcB = i_wb_forward_data;
